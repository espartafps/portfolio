...
export const projects: Project[] = [
  {
    ...
    tagline:
      'Como eventos geopolíticos globais impactam mais de 25.000 fundos de investimento brasileiros, detectado via Z-score, Random Forest e IA generativa.',
    problem:
  ...
  },
  {
    ...
    tagline:
      'Análise quantitativa de como as principais classes de ativos brasileiros se comportaram nas crises de 2020 a 2023.',
    problem:
      'Durante crises (COVID-19, invasão da Ucrânia, escândalo Americanas), gestores precisam saber quais ativos se recuperam mais rápido. Análises comparativas rigorosas são raras e muitas vezes anedóticas.',
    approach:
  ...
  },
  {
    ...
    approach:
      'Pipeline em cinco etapas: coleta de dados CVM, cálculo de mais de 20 métricas comportamentais (Sharpe, Sortino, Calmar, VaR, drawdown, alpha, beta), clustering HDBSCAN para agrupar por comportamento observado, ranking e exposição via FastAPI e Streamlit.',
    result:
